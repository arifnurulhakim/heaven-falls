...
class HrPeriodBattlepassController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            $query = HrPeriodBattlepass::query();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $period = HrPeriodBattlepass::create($periodData);
    ...
    {
        try {
            $period = HrPeriodBattlepass::findOrFail($id);
    ...
    {
        try {
            $period = HrPeriodBattlepass::find($id);
