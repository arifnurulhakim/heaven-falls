...
class HcSubscriptionRewardsController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            $query = HcSubscriptionReward::query();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $reward = HcSubscriptionReward::create($rewardData);
    ...
    {
        try {
            $reward = HcSubscriptionReward::findOrFail($id);
    ...
    {
        try {
            $reward = HcSubscriptionReward::find($id);
